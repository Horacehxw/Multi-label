...
class IndexIVF(Index):
    ...
    if _newclass:
        codes = _swig_property(_swigfaiss.IndexIVF_codes_get, _swigfaiss.IndexIVF_codes_set)
...
class IndexIVFPQCompact(IndexIVFPQ):
    ...
    def search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs):
        return _swigfaiss.IndexIVFPQCompact_search_preassigned(self, n, x, k, assign, centroid_dis, distances, labels, store_pairs)
